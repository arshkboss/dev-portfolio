...
export function ExperienceSection() {
  ...
  return (
    <section id="experience" className="py-20">
      <h2 className="text-3xl font-bold mb-12 text-start max-w-3xl mx-auto">Engineering Achievements</h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="ml-8 w-full" onClick={() => setSelectedProject(project)}>
                <div className="group cursor-pointer bg-card rounded-lg p-4 group-hover:bg-muted hover:shadow-lg transition-all">
